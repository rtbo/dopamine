...
extern(C) @nogc nothrow:
    ...
    void lua_callk(lua_State*,int,int,lua_KContext,lua_CFunction);
    int lua_pcallk(lua_State*,int,int,int,lua_KContext,lua_CFunction);
    int lua_load(lua_State*,lua_Reader,void*,const(char)*);
    int lua_dump(lua_State*,lua_Writer,void*);
    int lua_yieldk(lua_State*,int,lua_KContext,lua_CFunction);
